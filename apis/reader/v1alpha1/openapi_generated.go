...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"kubevault.dev/secrets-store-reader/apis/reader/v1alpha1.Secret":     schema_secrets_store_reader_apis_reader_v1alpha1_Secret(ref),
		"kubevault.dev/secrets-store-reader/apis/reader/v1alpha1.SecretList": schema_secrets_store_reader_apis_reader_v1alpha1_SecretList(ref),
	}
}
...
func schema_secrets_store_reader_apis_reader_v1alpha1_Secret(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "Secret holds secret data of a certain type. The total bytes of the values in the Data field must be less than MaxSecretSize bytes.",
...
func schema_secrets_store_reader_apis_reader_v1alpha1_SecretList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecretList is a list of Secret.",
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("kubevault.dev/secrets-store-reader/apis/reader/v1alpha1.Secret"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "kubevault.dev/secrets-store-reader/apis/reader/v1alpha1.Secret"},
	}
}
